...
async function loadWasmModule() {
  ...
  try {
    ...
    memoryOffset = 1024;
    console.log('[Backend] ✅ Módulo WebAssembly carregado com sucesso');
    return wasmInstance;
  } catch (error) {
    console.error('[Backend] ❌ Erro ao carregar módulo WASM:', error.message);
    throw error;
  }
}
...
// Hash de password usando WebAssembly (SHA-512, 10.000 iterações)
...
// Verificar password comparando com hash WASM
