...
import { validatePassword, validateName, isValidEmail, isValidRole, ARGON2_CONFIG } from '../utils/validation.js';
...
export const register = async (req, res) => {
  try {
    ...
    // Hash password com Argon2 (algoritmo mais seguro para senhas)
